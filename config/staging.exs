...
config :chainspark_api, ChainsparkApiWeb.Endpoint,
  ...
  url: [scheme: "https", host: "chainspark-api-staging.herokuapp.com", port: 443],
  check_origin: false,
...
# start per endpoint:
#
#     config :chainspark_api, ChainsparkApiWeb.Endpoint, server: true
#
...
config :chainspark_api, ChainsparkApi.Guardian,
  ...
  secret_key: "V84hNNfk0XTbE7BurIi3dTz2DIsxhOqdSw9H5Y93o4QUcYINejc4m9X98EpPJ8KD"
